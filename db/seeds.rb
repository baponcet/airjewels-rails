...
jewel1.photos.attach(io: file1, filename: "bracelet.png", content_type: "image/png")
jewel1.save
...
jewel2.photos.attach(io: file2, filename: "watch.png", content_type: "image/png")
jewel2.save
...
jewel3.photos.attach(io: file3, filename: "ring.png", content_type: "image/png")
jewel3.save
...
jewel4.photos.attach(io: file4, filename: "earring.png", content_type: "image/png")
jewel4.save
