...
user4.save!
puts "create watch 1"
watch1 = Jewel.new(name: 'Steel Watch', price_per_day: 50, brand: 'Christian Lacroix', category: 'Watch', user: user1,
...
bracelet5 = Jewel.new(name: '"Tête de lion" bracelet', price_per_day: 150, brand: 'Gucci', category: 'Bracelet', user: user4,
...
ring2.save!
puts "create ring 3"
ring3 = Jewel.new(name: 'Ellipse ring', price_per_day: 50, brand: 'Ginette NY', category: 'Ring', user: user1,
...
ring3.save!
puts "create ring 4"
ring4 = Jewel.new(name: 'B Blossom ring', price_per_day: 70, brand: 'Louis Vuitton', category: 'Ring', user: user2,
...
ring4.save!
puts "create ring 5"
ring5 = Jewel.new(name: 'White gold ring', price_per_day: 100, brand: 'Boucheron', category: 'Ring', user: user3,
...
earrings1 = Jewel.new(name: "Divas' Dream earrings ", price_per_day: 100, brand: 'Bulgari', category: 'Earring', user: user4,
  comment: "
...
earrings2 = Jewel.new(name: 'Pearls earrings YSL', price_per_day: 50, brand: 'Yves Saint Laurent', category: 'Earring', user: user4,
...
earrings3 = Jewel.new(name: 'Gold earrings', price_per_day: 60, brand: 'Versace', category: 'Earring', user: user1,
...
earrings4 = Jewel.new(name: "Olympe earrings", price_per_day: 80, brand: 'Hermes', category: 'Earring', user: user2,
...
earrings5 = Jewel.new(name: 'White gold earrings', price_per_day: 100, brand: 'Buccelati', category: 'Earring', user: user3,
...
necklace1 = Jewel.new(name: 'Medallion rose des vents', price_per_day: 150, brand: 'Dior', category: 'Necklace', user: user4,
...
necklace2 = Jewel.new(name: 'Alhambra necklace', price_per_day: 200, brand: 'Van Cleef and Arpels', category: 'Necklace', user: user4,
...
necklace4 = Jewel.new(name: 'Moon necklace', price_per_day: 70, brand: 'Pascale Monvoisin', category: 'Necklace', user: user1,
...
necklace5 = Jewel.new(name: 'Jeux de liens pendant', price_per_day: 90, brand: 'Chaumet Paris', category: 'Necklace', user: user3,
