...
User.create(email: 'fa.shah@gmail.com', first_name: 'Fariha', last_name: 'SHAH', password: 'somepassword',
            password_confirmation: 'somepassword', admin: false)
puts "create watch 1"
watch1 = Jewel.new(name: 'Montre en acier', price_per_day: 50, brand: 'Christian Lacroix', category: 'Watch', user_id: 1,
...
watch1.save
puts "create watch 2"
watch2 = Jewel.new(name: 'Milgauss Blue Dial 2022', price_per_day: 300, brand: 'Rolex', category: 'Watch', user_id: 3,
...
watch2.save
puts "create watch 3"
watch3 = Jewel.new(name: 'Code 11.59', price_per_day: 250, brand: 'Audemars Piguet', category: 'Watch', user_id: 2,
...
watch3.save
puts "create watch 4"
watch4 = Jewel.new(name: 'Titane GMT', price_per_day: 500, brand: 'Bremont Boeing', category: 'Watch', user_id: 3,
...
watch4.save
puts "create watch 5"
watch5 = Jewel.new(name: 'Elégante', price_per_day: 350, brand: 'F.P.Journe', category: 'Watch', user_id: 4,
  comment: "Conçue en 1956 pour répondre aux besoins des ingénieurs et des scientifiques, l’Oyster Perpetual Milgauss est une montre pionnière dans la résistance aux champs magnétiques. Elle est capable de résister à des champs magnétiques d’une ampleur de 1 000 gauss, d’où son nom. Montre unique en son genre, la Milgauss souligne les liens historiques qui unissent Rolex à la recherche scientifique.")
...
bracelet1 = Jewel.new(name: 'Bracelet bois de rose', price_per_day: 150, brand: 'Dior', category: 'Bracelet', user_id: 1,
...
bracelet2 = Jewel.new(name: 'Astrale', price_per_day: 100, brand: 'Edenly', category: 'Bracelet', user_id: 2,
...
bracelet3 = Jewel.new(name: 'Allegra', price_per_day: 400, brand: 'De Grisogno', category: 'Bracelet', user_id: 3,
...
bracelet4 = Jewel.new(name: 'Serpenti Viper', price_per_day: 200, brand: 'Bulgari', category: 'Bracelet', user_id: 1,
...
bracelet5 = Jewel.new(name: 'Bracelet tête de Lion', price_per_day: 150, brand: 'Gucci', category: 'Bracelet', user_id: 4,
...
bracelet5.save
puts "create ring 1"
ring1 = Jewel.new(name: 'Rose des vents', price_per_day: 200, brand: 'Dior', category: 'Ring', user_id: 3,
...
ring1.save
puts "create ring 2"
ring2 = Jewel.new(name: "Second Wife Band", price_per_day: 100, brand: 'Sansoeurs', category: 'Ring', user_id: 2,
...
ring2.save
puts "create ring 3"
ring3 = Jewel.new(name: 'Ellipse', price_per_day: 50, brand: 'Ginette NY', category: 'Ring', user_id: 1,
...
ring3.save
puts "create ring 4"
ring4 = Jewel.new(name: 'B Blossom Or jaune', price_per_day: 70, brand: 'Louis Vuitton', category: 'Ring', user_id: 2,
...
earrings1 = Jewel.new(name: "Divas' Dream", price_per_day: 100, brand: 'Bulgari', category: 'Earring', user_id: 4,
...
earrings5 = Jewel.new(name: 'Bague en Or blanc', price_per_day: 100, brand: 'Buccelati', category: 'Earring', user_id: 3,
...
necklace1 = Jewel.new(name: 'Medaillon rose des vents', price_per_day: 150, brand: 'Dior', category: 'Necklace', user_id: 4,
...
necklace2 = Jewel.new(name: 'Collier Vintage Alhambra', price_per_day: 200, brand: 'Van Cleef and Arpels', category: 'Necklace', user_id: 4,
...
necklace3 = Jewel.new(name: "Diva's Dream collier", price_per_day: 200, brand: 'Bulgari', category: 'Necklace', user_id: 2,
  comment: "Boucles d'oreilles en or 18 carats (750/1000) et émail Opera Tulle")
...
necklace4 = Jewel.new(name: 'Collier Moon', price_per_day: 70, brand: 'Pascale Monvoisin', category: 'Necklace', user_id: 1,
...
necklace5 = Jewel.new(name: 'PENDENTIF JEUX DE LIENS', price_per_day: 90, brand: 'Chaumet Paris', category: 'Necklace', user_id: 3,
